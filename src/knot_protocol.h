...
#define KNOT_EVENT_CHANGE_UPPER_FLAG		(KNOT_EVT_FLAG_UPPER_THRESHOLD |\
						KNOT_EVT_FLAG_CHANGE)
#define KNOT_EVENT_CHANGE_LOWER_FLAG		(KNOT_EVT_FLAG_LOWER_THRESHOLD |\
						KNOT_EVT_FLAG_CHANGE)
#define KNOT_EVENT_UPPER_LOWER_FLAG		(KNOT_EVT_FLAG_LOWER_THRESHOLD |\
