...
#define UNIT_RESISTANCE_MASK	(UNIT_MASK(KNOT_UNIT_RESISTANCE_OHM))
...
#define UNIT_ANG_VEL_MASK	(UNIT_MASK(KNOT_UNIT_ANGULAR_VELOCITY_RADSEG) | \
				UNIT_MASK(KNOT_UNIT_ANGULAR_VELOCITY_DEGSEG))
...
static const struct schema {
	...
	{KNOT_VALUE_TYPE_FLOAT, UNIT_ACCELERATION_MASK	},
